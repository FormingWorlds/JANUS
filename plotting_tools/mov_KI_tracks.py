                        ...
                        for T_surf in tmp_range:
                            ...
                            for vol in vol_list_sorted.keys():
                                ...
                                if atm.vol_list[vol] > 1e-10:
                                    ...
                                    ax5.semilogy(atm.x_cond[vol], atm.p, color=ga.vol_colors[vol][4], lw=ls_ind, ls="--", label=ga.vol_latex[vol]+" cond.")
                                    ax5.semilogy(atm.x_gas[vol], atm.p, color=ga.vol_colors[vol][4], lw=ls_ind, ls="-", label=ga.vol_latex[vol]+" gas")
