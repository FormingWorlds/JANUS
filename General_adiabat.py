...
def moist_adiabat(atm):
    ...
    T_dry = dry_adiabat( atm.ts, atm.p, atm.cp )
    ax1.semilogy( T_dry, atm.p , color='black', ls="--", lw=ls_adiabat, label=r'Dry adiabat')
    ...
    ax2.set_xlabel(r'Molar abundance $X_{\mathrm{vol,phase}}/X_{gas,tot}$')
