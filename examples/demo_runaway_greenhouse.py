...
if __name__ == '__main__':
    ...
    # Get literature data
    g2013 = np.loadtxt(
        dirs['janus'] + 'data/comparison_data/Goldblatt13_data.txt',
        dtype=float,
        skiprows=2,
        delimiter=',',
    ).T
    k2013 = np.loadtxt(
        dirs['janus'] + 'data/comparison_data/Kopparapu13_data.txt',
        dtype=float,
        skiprows=2,
        delimiter=',',
    ).T
    h2015 = np.loadtxt(
        dirs['janus'] + 'data/comparison_data/Hamano15_data.txt',
        dtype=float,
        skiprows=2,
        delimiter=',',
    ).T
    s2023 = np.loadtxt(
        dirs['janus'] + 'data/comparison_data/Selsis23_convective.txt',
        dtype=float,
        skiprows=2,
        delimiter=',',
    ).T
