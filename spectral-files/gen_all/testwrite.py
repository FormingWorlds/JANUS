...
# CH4
#f.write('Ccorr_k -F pt48 -D ch4-hitran.par -R 1 300 -c 2500.0 -i 1.0 -l 6 1.0e1 -t 1.0e-2 -k -s sp_spider +p -lk -o ch4_o -m ch4_m -L ch4_lbl.nc -np 16'+ '\n')
...
# O2O2
#f.write('Ccorr_k -F pt_cont -CIA O2-O2_2018b.cia -R 1 300 -i 1.0 -ct 7 7 1.0e2 -t 1.0e-2 -s ' + 'sp_spider' + ' +p -lk -o o2o2_o -m o2o2_m -L o2o2_lbl.nc' + '\n')
'''
# Add to spec file with prep_spec
f.write('prep_spec <<EOF'+ '\n')
# Select spectral file
...
f.write('Ccorr_k -F pt_cont -CIA N2-N2_2018.cia -R 1 300 -c 2500.0 -i 1.0 -ct 13 13 1.0e4 -t 1.0e-2 -s ' + 'sp_spider' + ' +p -lk -o n2n2_o -m n2n2_m -L n2n2_lbl.nc' + '\n')
