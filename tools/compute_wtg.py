...
planets = {
    'Earth': {
        ...
        'Gravity': grav_Earth,
        'Semi-major axis': AU,
        'Angular velocity': angular_velocity(1.0),
    },
    'TRAPPIST-1b': {
        'Stellar Mass': 0.0898 * M_Sun,
        'Stellar Luminosity': 0.000553 * L_Sun,
        'Radius': 1.116 * radius_Earth,
        'Gravity': 1.102 * grav_Earth,
        'Semi-major axis': 0.01154 * AU,
        'Angular velocity': angular_velocity(1.510826),
    },
    'TRAPPIST-1d': {
        'Stellar Mass': 0.0898 * M_Sun,
        'Stellar Luminosity': 0.000553 * L_Sun,
        'Radius': 0.788 * radius_Earth,
        'Gravity': 0.624 * grav_Earth,
        'Semi-major axis': 0.02227 * AU,
        'Angular velocity': angular_velocity(4.049219),
    },
    'TRAPPIST-1e': {
        'Stellar Mass': 0.0898 * M_Sun,
        'Stellar Luminosity': 0.000553 * L_Sun,
        'Radius': 0.920 * radius_Earth,
        'Gravity': 0.817 * grav_Earth,
        'Semi-major axis': 0.02925 * AU,
        'Angular velocity': angular_velocity(6.101013),
    },
    'Proxima-b': {
        'Stellar Mass': 0.1221 * M_Sun,
        'Stellar Luminosity': 0.001567 * L_Sun,
        'Radius': np.array([0.94, 1.4]) * radius_Earth,
        'Gravity': surface_gravity(1.07, [0.94, 1.4]),
        'Semi-major axis': 0.04856 * AU,
        'Angular velocity': angular_velocity(11.1868),
    },
    'Teegarden-b': {
        'Stellar Mass': 0.09455120 * M_Sun,
        'Stellar Luminosity': 0.00073 * L_Sun,
        'Radius': 1.02 * radius_Earth,
        'Mass': 1.05 * mass_Earth,
        'Gravity': surface_gravity(1.05, 1.02),
        'Semi-major axis': 0.0252 * AU,
        'Angular velocity': angular_velocity(4.9100),
    },
    'Teegarden-c': {
        'Stellar Mass': 0.09455120 * M_Sun,
        'Stellar Luminosity': 0.00073 * L_Sun,
        'Radius': 1.04 * radius_Earth,
        'Mass': 1.11 * mass_Earth,
        'Gravity': surface_gravity(1.11, 1.04),
        'Semi-major axis': 0.0443 * AU,
        'Angular velocity': angular_velocity(11.409),
    },
}
...
atmospheres = {
    ...
    '300K N2-H2O': {
        'H2O': ga.p_sat('H2O', 300.0) / (1e5 + ga.p_sat('H2O', 300.0)),
        'CO2': 0.0,
        'O3': 0.0,
        'N2O': 0.0,
        'CO': 0.0,
...
ax.plot(
    ...
    ls='--',
    color=colors[1],
    label=planet + r' $p_{\mathrm{N2}}$=1 bar, $p_{\mathrm{H2O}}=p_{\mathrm{sat}}$(300K) Pa',
)
...
ax.plot(
    ...
    ls='-.',
    color=colors[2],
    label=planet + r' $p_{\mathrm{N2}}$=1 bar, $p_{\mathrm{H2O}}$=260 bar',
)
