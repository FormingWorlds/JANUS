...
H2O.MolecularWeight = 1.801528e01
H2O.name = 'Water'
H2O.formula = 'H2O'
...
CH4.MolecularWeight = 1.604000e01
CH4.name = 'Methane'
CH4.formula = 'CH4'
...
CO2.MolecularWeight = 4.401000e01
...
CO.CriticalPointT = 1.134450e02
CO.CriticalPointP = 3.498750e06
CO.TriplePointT = 6.795000e01
CO.TriplePointP = 1.530000e04
CO.L_vaporization_BoilingPoint = None
CO.L_vaporization_TriplePoint = 2.142857e05  #
CO.L_fusion = None
CO.L_sublimation = 2.7142857e05
CO.rho_liquid_BoilingPoint = None
CO.rho_liquid_TriplePoint = None
CO.rho_solid = None
CO.cp = 1.04000e03
CO.gamma = 1.400000e00
CO.MolecularWeight = 2.800970e01
CO.name = 'Carbon Monoxide'
CO.formula = 'CO'
CO.L_vaporization = 2.142857e05
CO.rho_liquid = None
# ------------------------
N2 = gas()
...
N2.MolecularWeight = 2.801340e01
N2.name = 'Nitrogen'
N2.formula = 'N2'
...
O2.MolecularWeight = 3.199900e01
O2.name = 'Oxygen'
O2.formula = 'O2'
...
O3.CriticalPointT = 2.61e02
O3.CriticalPointP = 5.57e6
O3.TriplePointT = 8.015e01
O3.TriplePointP = 7.346e-01
O3.L_vaporization_BoilingPoint = 2.8849e05
O3.L_vaporization_TriplePoint = None  # left to find
O3.L_fusion = 4.1668e04
O3.L_sublimation = 0.1e-99  # !CAREFUL! Actually: None
O3.rho_liquid_BoilingPoint = 1.34908e03
O3.rho_liquid_TriplePoint = None  # left to find
O3.rho_solid = 1.351000e03  # left to find
O3.cp = 8.197165e02  # https://webbook.nist.gov/cgi/cbook.cgi?ID=C10028156&Mask=1&Type=JANAFG&Table=on#JANAFG
O3.gamma = 1.393000e00  # left to find cv
O3.MolecularWeight = 4.798e01
O3.name = 'Ozone'
O3.formula = 'O3'
O3.L_vaporization = 2.8849e05  # left to find L_vaporization_TriplePoint
O3.rho_liquid = 1.34908e03
# ------------------------
H2 = gas()
...
H2.MolecularWeight = 2.015880e00
H2.name = 'Hydrogen'
H2.formula = 'H2'
...
He.MolecularWeight = 4.002602e00
He.name = 'Helium'
He.formula = 'He'
...
NH3.MolecularWeight = 1.703100e01
NH3.name = 'Ammonia'
NH3.formula = 'NH3'
...
def B(nu, T):
    if nu <= 0.0:  # Rayleigh-Jeans limit: B -> 0 as nu -> 0
        return 0.0
...
def dB(nu, T):
    u = min(h * nu / (k * T), 500.0)  # To prevent overflow
    dB = (2 * h**2 * nu**4 / (c**2 * k * T**2)) * (
        math.exp(u) / (math.exp(u) - 1) ** 2
    )  # np.exp can take arrays as arguments, math.exp cannot.
    return dB
...
class MoistAdiabat:
    ...
    def __init__(self, condensible=H2O, noncon=air):
        ...
        def slope(logpa, logT):
            ...
            den = self.cpa + (self.cpc + (self.L / (self.Rc * T) - 1.0) * (self.L / T)) * qsat
            return num / den
