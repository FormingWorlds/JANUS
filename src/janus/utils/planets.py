...
Mercury.year = 87.969 * 24.0 * 3600.0  # Sidereal length of year
Mercury.eccentricity = 0.2056  # Eccentricity
Mercury.day = 4222.6 * 3600.0  # Mean tropical length of day
Mercury.obliquity = 0.01  # Obliquity to orbit (deg)
Mercury.Lequinox = None  # Longitude of equinox (deg)
#
Mercury.Tsbar = 440.0  # Mean surface temperature
...
Venus.year = 224.701 * 24.0 * 3600.0  # Sidereal length of year
Venus.eccentricity = 0.0067  # Eccentricity
Venus.day = 2802.0 * 3600.0  # Mean tropical length of day
Venus.obliquity = 177.36  # Obliquity to orbit (deg)
Venus.Lequinox = None  # Longitude of equinox (deg)
#
Venus.Tsbar = 737.0  # Mean surface temperature
Venus.Tsmax = 737.0  # Maximum surface temperature
...
Earth.year = 365.256 * 24.0 * 3600.0  # Sidereal length of year
Earth.eccentricity = 0.0167  # Eccentricity
Earth.day = 24.000 * 3600.0  # Mean tropical length of day
Earth.obliquity = 23.45  # Obliquity to orbit (deg)
Earth.Lequinox = None  # Longitude of equinox (deg)
#
Earth.Tsbar = 288.0  # Mean surface temperature
...
Mars.year = 686.98 * 24.0 * 3600.0  # Sidereal length of year
Mars.eccentricity = 0.0935  # Eccentricity
Mars.day = 24.6597 * 3600.0  # Mean tropical length of day
Mars.obliquity = 25.19  # Obliquity to orbit (deg)
Mars.Lequinox = None  # Longitude of equinox (deg)
#
Mars.Tsbar = 210.0  # Mean surface temperature
Mars.Tsmax = 295.0  # Maximum surface temperature
...
Jupiter.year = 4332.0 * 24.0 * 3600.0  # Sidereal length of year
Jupiter.eccentricity = 0.0489  # Eccentricity
Jupiter.day = 9.9259 * 3600.0  # Mean tropical length of day
Jupiter.obliquity = 3.13  # Obliquity to orbit (deg)
Jupiter.Lequinox = None  # Longitude of equinox (deg)
#
Jupiter.Tsbar = 165.0  # Mean surface temperature
...
Saturn.year = 10759.0 * 24.0 * 3600.0  # Sidereal length of year
Saturn.eccentricity = 0.0565  # Eccentricity
Saturn.day = 10.656 * 3600.0  # Mean tropical length of day
Saturn.obliquity = 26.73  # Obliquity to orbit (deg)
Saturn.Lequinox = None  # Longitude of equinox (deg)
#
Saturn.Tsbar = 134.0  # Mean surface temperature
...
Uranus.year = 30685.4 * 24.0 * 3600.0  # Sidereal length of year
Uranus.eccentricity = 0.0457  # Eccentricity
Uranus.day = 17.24 * 3600.0  # Mean tropical length of day
Uranus.obliquity = 97.77  # Obliquity to orbit (deg)
Uranus.Lequinox = None  # Longitude of equinox (deg)
#
Uranus.Tsbar = 76.0  # Mean surface temperature
...
Neptune.year = 60189.0 * 24.0 * 3600.0  # Sidereal length of year
Neptune.eccentricity = 0.0113  # Eccentricity
Neptune.day = 16.11 * 3600.0  # Mean tropical length of day
Neptune.obliquity = 28.32  # Obliquity to orbit (deg)
Neptune.Lequinox = None  # Longitude of equinox (deg)
#
Neptune.Tsbar = 72.0  # Mean surface temperature
...
Pluto.L = 0.89  # Annual mean solar constant (current)
#
Pluto.rsm = 5906.0e9  # Semi-major axis
Pluto.year = 90465.0 * 24.0 * 3600.0  # Sidereal length of year
Pluto.eccentricity = 0.2488  # Eccentricity
Pluto.day = 153.2820 * 3600.0  # Mean tropical length of day
Pluto.obliquity = 122.53  # Obliquity to orbit (deg)
Pluto.Lequinox = None  # Longitude of equinox (deg)
#
Pluto.Tsbar = 50.0  # Mean surface temperature
...
Moon.day = 28.0 * 24.0 * 3600.0  # Mean tropical length of day (approx)
...
Moon.Tsmax = 400.0  # Maximum surface temperature
Moon.Tsmin = 100.0  # Minimum surface temperature
...
Titan.albedo = 0.21  # Bond albedo (Not yet updated from Cassini)
#
...
Titan.day = 15.9452 * 24.0 * 3600.0  # Mean tropical length of day
...
#
Titan.Tsbar = 95.0  # Mean surface temperature
...
Europa.albedo = 0.67  # Bond albedo
#
...
Europa.day = 3.551 * 24.0 * 3600.0  # Mean tropical length of day
Europa.obliquity = Jupiter.obliquity  # Obliquity to plane of ecliptic
Europa.Lequinox = None  # Longitude of equinox
#
Europa.Tsbar = 103.0  # Mean surface temperature
Europa.Tsmax = 125.0  # Maximum surface temperature

Triton = Planet()
Triton.name = 'Triton'  # Name of the planet
Triton.a = 2.7068e6 / 2.0  # Mean radius of planet
...
Triton.day = 5.877 * 24.0 * 3600.0  # Mean tropical length of day
