...
def cp_cond(vol, tmp, cp_mode='T-dependent'):
    ...
    match vol:
        ...
        case 'H2O':
            temp_array = np.concatenate((np.arange(274.0, 647.0, 20.0), [646]))  # K
            cp_array = np.array(
                [
                    75.97,
                    75.37,
        ...
        case 'H2':
            if cp_mode != 'constant':
                ...
                t = 10.0
            specific_heat_mass_units = (
                14.43877 - 1.691 * t + 0.10687 * t**2 - 0.00174 * t**3
            )  # J/g/K
        ...
        case 'N2':
            temp_array = np.arange(64.0, 129.0, 5.0)  # K
            cp_array = np.array(
                [
                    56.07,
                    56.36,
        ...
        case 'O2':
            return (
                4.184 * 10
            )  # J/K/mol; approximate value, at the higher end of the liquid temperature range
